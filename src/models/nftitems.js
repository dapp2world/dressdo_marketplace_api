...
const NFTITEMSchema = mongoose.Schema(
  {
    ...
    lastSalePricePaymentToken: { type: String, default: "dt" }, // payment erc20 token address
...
NFTITEMSchema.methods.toSimpleJson = function () {
  return {
